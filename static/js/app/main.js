...
import { renderApi, selectOp, initSendHandler } from './workbench/core.js';
...
(() => {
  ...
  document.querySelectorAll("[data-api-id]").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      if (window.ApiGuide) window.ApiGuide.refresh();
  ...
  // ---------------------------------------------------------------------
  // ---------------------------------------------------------------------
  // API workbench render/select/send core lives in workbench/core.js
  // (renderApi, selectOp exported; initSendHandler wires Send).
